...
public class Console extends JFrame implements WindowListener, FocusListener {
    ...
    public void doEnter() {
        ...
        ApplicationFrame appFrame = Application.getInstance().getCurrentAppFrame();
        interpreter.set("document", appFrame.getCurrentDocument());
        interpreter.set("root", appFrame.getCurrentDocument().getNodeLibrary().getRoot());
        interpreter.set("parent", appFrame.getCurrentDocument().getActiveNetwork());
        interpreter.set("node", appFrame.getCurrentDocument().getActiveNode());
