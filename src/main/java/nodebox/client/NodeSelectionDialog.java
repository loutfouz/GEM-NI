...
public class NodeSelectionDialog extends JDialog {
    ...
    private class FilteredNodeListModel implements ListModel {
        ...
        private FilteredNodeListModel(NodeLibrary library, NodeRepository repository, String category) {
...
//                }
    ...
    public NodeSelectionDialog(NodeLibrary library, NodeRepository repository, String category) {
        this(null, library, repository, category);
    }

    public NodeSelectionDialog(Frame owner, NodeLibrary library, NodeRepository repository, String category) {
        super(owner, "New Node", true);
        getRootPane().putClientProperty("Window.style", "small");
        JPanel panel = new JPanel(new BorderLayout());
        this.repository = repository;
        filteredNodeListModel = new FilteredNodeListModel(library, repository, category);
        ...
        if (category == null) // only load categories if we do not have a fixed category
        	reloadCategories();
