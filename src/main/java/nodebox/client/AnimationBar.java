...
public class AnimationBar extends JPanel implements ChangeListener {
    ...
    public AnimationBar(final NodeBoxDocument document) {
        ...
        setPreferredSize(new Dimension(250, ANIMATION_BAR_HEIGHT));
        setMinimumSize(new Dimension(250, ANIMATION_BAR_HEIGHT));
        setMaximumSize(new Dimension(250, ANIMATION_BAR_HEIGHT));
    ...
    public void stateChanged(ChangeEvent changeEvent) {
        ...
        document.getAnimationManager().setFrame(frame);
    }
    ...
    public void playAnimation() {
        ...
        document.getAnimationManager().playAnimation();
    ...
    public void stopAnimation() {
        ...
        document.getAnimationManager().stopAnimation();
    ...
    public void rewindAnimation() {
        stopAnimation();
        document.getAnimationManager().rewindAnimation();
    }
