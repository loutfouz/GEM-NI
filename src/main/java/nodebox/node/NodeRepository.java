...
public class NodeRepository {
    ...
    public static NodeRepository getFilteredNodeRepository(NodeRepository nodeRepository, String category) {
    	ImmutableMap.Builder<String, NodeLibrary> builder = ImmutableMap.builder();
    	for (NodeLibrary library : nodeRepository.getLibraries()) {
    		System.out.println(library + " vs. " + category);
    ...
    public NodeLibrary nodeLibraryForNode(Node node) {
        for (NodeLibrary library : libraryMap.values()) {
        	//System.out.println("Ribrary map=" + library.getName() + ",children:" + library.getRoot().getChildren());
