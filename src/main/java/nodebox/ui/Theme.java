...
public class Theme {
	...
	public static int jamBorderSize = 25;
	
	//Three color schemes for alternatives: active, passive, idle
	public static Color ACTIVE_COLOR = new Color(250, 250, 250);
	public static Color PASSIVE_COLOR = new Color(150, 150, 150);
	public static Color IDLE_COLOR = new Color(80, 80, 80);
    ...
    public static final Color CHANGED_NODE_COLOR = new Color(255, 0, 0);
    public static final Color DRAGGED_NODE_COLOR = new Color(120, 41, 41); //drag nodes are temporarily shown
    public static final Color NEW_NODE_COLOR = new Color(0, 178, 51);
    public static final float TRANSPARENCY_LEVEL =  0.2f;
    ...
    //public static final Color SELECTED_TAB_MASTER_BACKGROUND_COLOR = new Color(230, 0, 230);
    public static final Color MASTER_TEXT_NORMAL_COLOR = new Color(255, 255, 255);
    public static final Color SELECTED_TAB_SYNCHED_BACKGROUND_COLOR = new Color(0, 255, 0);
    


    // Network view

    public static final Color NETWORK_GRID_COLOR = new Color(75, 75, 75);
    public static final Color ACTIVE_NETWORK_GRID_COLOR = new Color(170, 170, 170);
    ...
    public static final Color CONNECTION_DEFAULT_COLOR = new Color(0, 0, 0);
    ...
    //public static final Color PORT_LABEL_BACKGROUND = new Color(220, 220, 220);
    public static final Color PORT_LABEL_BACKGROUND = new Color(ACTIVE_COLOR.getRed()-30,ACTIVE_COLOR.getGreen()-30, ACTIVE_COLOR.getBlue()-30);
    ...
    public static final Font CONNECTED_FONT; //font for <connected> port value (need it to be bigger, it's the only way to resize that component
    ...
    static {
        ...
        if (Platform.onMac()) {
            ...
            NETWORK_FONT = new Font("Lucida Grande", Font.PLAIN, 28);
            ...
            NETWORK_FONT = new Font("Verdana", Font.PLAIN, 27);
        ...
        CONNECTED_FONT = new Font("Lucida Grande", Font.PLAIN, 24);
