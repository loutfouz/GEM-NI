...
public class NodeLibraryControllerTest {
    ...
    public void testCreateNode() {
        ...
        controller.createNode("/", proto); //Aug 13, 2013 null for uuid, shumon
    ...
    public void testGroupIntoNetwork() {
        ...
        Node subnet = controller.groupIntoNetwork("/", ImmutableList.of(numberNode, invertNode), UUID.randomUUID());
    ...
    public void testGroupAndPublish() {
        ...
        Node subnet1 = controller.groupIntoNetwork("/", ImmutableList.of(piNode, multiply1Node, multiply2Node), UUID.randomUUID());
        Node root = controller.getRootNode();
    ...
    public void testGroupingAndPortNaming() {
        ...
        Node subnet1 = controller.groupIntoNetwork("/", ImmutableList.of(multiply1Node, add1Node, divide1Node), UUID.randomUUID());
        Node root = controller.getRootNode();
    ...
    public void testGroupingRenderedBeforeEnd() {
        ...
        controller.groupIntoNetwork("/", ImmutableList.of(numberNode, invert1Node, invert2Node), UUID.randomUUID());
